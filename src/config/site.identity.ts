export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'mailtwitter',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Mailtwitter',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'mailtwitter.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mailtwitter.com',
